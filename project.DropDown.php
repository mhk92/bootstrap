	...
	<div class="offcanvas offcanvas-end" tabindex="-1" id="sidebar" aria-labelledby="sidebar-label">
		...
		<div class="offcanvas-body">
			...
			<div class="dropdown mt-5">
				<button class="btn btn-secondary dropdown-toggle" id="project-dd" data-bs-toggle="dropdown">
					choose something
				</button>
				<ul class="dropdown-menu" aria-labelledby="project-dd">
					<li><a href="#" class="dropdown-item">something1</a></li>
					<li><a href="#" class="dropdown-item">something2</a></li>
					<li><a href="#" class="dropdown-item">something3</a></li>
					<li><a href="#" class="dropdown-item">something4</a></li>
				</ul>
			</div>
		</div>
	</div>
